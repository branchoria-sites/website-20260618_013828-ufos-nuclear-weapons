...
show_ads: true
description: Radar images matter most when investigators can trace when, how and by whom they were made and preserved.
hero_summary: Radar images matter most when investigators can trace when, how and by whom they were made and preserved.
layout: default
...
title: What Can a Radarscope Photo Prove?
title_full: What Can a Radarscope Photo Prove?
display_title_short: Radar Photos
display_title: Radar Photos
heading_title: What Can a Radarscope Photo Prove?
page_heading_title: What Can a Radarscope Photo Prove?
source_count: 35
infographic_count: 3
planned_sections:
- What a radarscope image can and cannot show
...
image: /assets/images/UFOs_and_nuclear_wea_3f6b18_radar_evidence_977bd6_radarscope_chain_cus_1a5617-Illustration-1-social.jpg
---

## Introduction

In nuclear-base UFO cases, a radarscope photograph is often treated as a dramatic piece of evidence because it appears to show a [radar]({{ 'radar/' | relative_url }}) target frozen in time. Yet the photograph itself rarely proves what the target was. Its value depends on whether investigators can establish when it was taken, what radar mode was being used, who handled the image, and whether the original sequence survived intact. A radarscope photo is therefore best understood as one element in a chain of evidence rather than a standalone proof.
...
Conversely, an undated radar photograph with no preserved settings may reveal little beyond the fact that someone once saw something noteworthy on a screen.
...
<img src="{{ "/assets/images/UFOs_and_nuclear_wea_3f6b18_radar_evidence_977bd6_radarscope_chain_cus_1a5617-Illustration-2-dark.svg" | relative_url }}" alt="Radar Photos illustration 2" data-theme-src-dark="{{ "/assets/images/UFOs_and_nuclear_wea_3f6b18_radar_evidence_977bd6_radarscope_chain_cus_1a5617-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/UFOs_and_nuclear_wea_3f6b18_radar_evidence_977bd6_radarscope_chain_cus_1a5617-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## For radarscope photographs, common custody questions include
...
The lesson is broader than the Minot case. Radar photographs become persuasive not because they show an extraordinary-looking target, but because they can be connected to a documented sequence of events. The evidential question is not simply what appears in the image. It is whether the image can be traced, authenticated and placed within a reliable record of who created it, when it was created, and how it was preserved.
