...
show_ads: true
description: Minot's witness record is strongest when its separate reports are compared rather than blended into one seamless story.
hero_summary: Minot's witness record is strongest when its separate reports are compared rather than blended into one seamless story.
layout: default
permalink: /witness-puzzle/
sidebar_expanded_urls:
- /ufos-and-nuclear-weapons/
- /minot/
nav_short_title: Witness puzzle
title: Do the Minot witnesses describe the same thing?
title_full: Do the Minot witnesses describe the same thing?
display_title_short: Witness puzzle
display_title: Witness puzzle
heading_title: Do the Minot witnesses describe the same thing?
page_heading_title: Do the Minot witnesses describe the same thing?
source_count: 28
infographic_count: 3
planned_sections:
- What missile field personnel described
- What Major Partin later recalled seeing
- Why matching separate sightings is difficult
...
prev_link:
  ...
  heading_title: Was the B 52 radar contact a real object?
header:
  og_image: /assets/images/UFOs_and_nuclear_wea_3f6b18_minot_b52_case_11d4a1_ground_air_witnesses_83ce03-Illustration-1-social.jpg
  preview_image: /assets/images/UFOs_and_nuclear_wea_3f6b18_minot_b52_case_11d4a1_ground_air_witnesses_83ce03-Illustration-1.webp
image: /assets/images/UFOs_and_nuclear_wea_3f6b18_minot_b52_case_11d4a1_ground_air_witnesses_83ce03-Illustration-1-social.jpg
---
...
The temptation in the Minot case is to construct a seamless narrative: a UFO appears near missile [silos]({{ 'silos/' | relative_url }}), moves across the missile field, is tracked by radar, and is then visually observed by the B-52 crew. The documentary record is less straightforward.
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Compiles military witness reports from nuclear facilities.</p>
        <div class="fr-book-actions">
