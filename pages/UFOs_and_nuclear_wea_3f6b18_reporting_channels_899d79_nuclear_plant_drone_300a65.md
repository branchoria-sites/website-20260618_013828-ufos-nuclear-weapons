...
show_ads: true
description: Drone reports at nuclear plants show why the first channel must link site security with airspace and law-enforcement authorities.
hero_summary: Drone reports at nuclear plants show why the first channel must link site security with airspace and law-enforcement authorities.
layout: default
...
title: Who gets called when drones appear?
title_full: Who gets called when drones appear?
display_title_short: Drone reports
display_title: Drone reports
heading_title: Who gets called when drones appear?
page_heading_title: Who gets called when drones appear?
source_count: 33
infographic_count: 3
planned_sections:
...
image: /assets/images/UFOs_and_nuclear_wea_3f6b18_reporting_channels_899d79_nuclear_plant_drone_300a65-Illustration-1-social.jpg
---
...
This reporting chain illustrates a broader lesson for nuclear-site anomaly reporting: the people who see an object are rarely the same people who can identify it, track it across airspace or investigate who operated it.
...
* Camera, [radar]({{ 'radar/' | relative_url }}) or other sensor records.
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Explains tracking and responding to aerial threats.</p>
        <div class="fr-book-actions">
