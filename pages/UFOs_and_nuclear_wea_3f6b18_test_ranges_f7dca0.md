...
- UFOs_and_nuclear_wea_3f6b18_test_ranges_f7dca0_index
...
show_ads: true
description: Missile and weapons test ranges naturally produce unusual observations that can be mistaken for extraordinary craft.
hero_summary: Missile and weapons test ranges naturally produce unusual observations that can be mistaken for extraordinary craft.
layout: default
permalink: /test-ranges/
sidebar_expanded_urls:
- /ufos-and-nuclear-weapons/
nav_short_title: Test Ranges
title: Why Test Ranges Generate UFO Stories
title_full: Why Test Ranges Generate UFO Stories
display_title_short: Test Ranges
display_title: Test Ranges
heading_title: Why Test Ranges Generate UFO Stories
page_heading_title: Why Test Ranges Generate UFO Stories
source_count: 145
infographic_count: 3
planned_sections:
...
image: /assets/images/UFOs_and_nuclear_wea_3f6b18_test_ranges_f7dca0-overview-social.jpg
---

## Introduction

Nuclear test ranges and missile ranges generate UFO stories because they combine spectacular sky effects with [secrecy]({{ 'secrecy/' | relative_url }}), distance and high stakes. Rockets climb into sunlight while observers stand in darkness; re-entry vehicles, decoys and fuel dumps can look like structured objects; and restricted ranges often prevent clear public explanations at the time. In the nuclear-weapons context, that creates a distinctive family of cases: not simply “lights in the sky”, but lights and films associated with missiles, warheads, radars, instrumentation crews and [classified tests]({{ 'secret-tests/' | relative_url }}).
...
<img src="{{ "/assets/images/UFOs_and_nuclear_wea_3f6b18_test_ranges_f7dca0-Illustration-1-dark.svg" | relative_url }}" alt="Test Ranges illustration 1" data-theme-src-dark="{{ "/assets/images/UFOs_and_nuclear_wea_3f6b18_test_ranges_f7dca0-Illustration-1-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/UFOs_and_nuclear_wea_3f6b18_test_ranges_f7dca0-Illustration-1-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## Unusual lights from tests
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Useful background for interpreting range-generated reports.</p>
        <div class="fr-book-actions">
