...
show_ads: true
description: Late disclosure may be understandable, but years of retelling can mix memory, rumor, media and interpretation.
hero_summary: Late disclosure may be understandable, but years of retelling can mix memory, rumor, media and interpretation.
layout: default
permalink: /late-accounts/
sidebar_expanded_urls:
- /ufos-and-nuclear-weapons/
- /witnesses/
nav_short_title: Late Accounts
title: Why old UFO memories become harder to test
title_full: Why old UFO memories become harder to test
display_title_short: Late Accounts
display_title: Late Accounts
heading_title: Why old UFO memories become harder to test
page_heading_title: Why old UFO memories become harder to test
source_count: 44
infographic_count: 3
planned_sections:
...
image: /assets/images/UFOs_and_nuclear_wea_3f6b18_military_witnesses_464c20_delayed_ufo_testimon_f06ff6-Illustration-1-social.jpg
---
...
<img src="{{ "/assets/images/UFOs_and_nuclear_wea_3f6b18_military_witnesses_464c20_delayed_ufo_testimon_f06ff6-Illustration-2-dark.svg" | relative_url }}" alt="Late Accounts illustration 2" data-theme-src-dark="{{ "/assets/images/UFOs_and_nuclear_wea_3f6b18_military_witnesses_464c20_delayed_ufo_testimon_f06ff6-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/UFOs_and_nuclear_wea_3f6b18_military_witnesses_464c20_delayed_ufo_testimon_f06ff6-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## What early records can and cannot fix
...
* Maintenance records
* Command memoranda
* [Radar]({{ 'radar/' | relative_url }}) or sensor data
* Audio recordings
